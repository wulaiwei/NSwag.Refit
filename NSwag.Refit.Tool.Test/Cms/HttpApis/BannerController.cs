...
namespace Cms
{
    public interface IBannerController
    {
        ...
        /// <summary>根据条件查询广告位列表并分页</summary>
        ...
        /// <summary>根据sysno获取广告位信息</summary>
        /// <param name="sysno">sysno</param>
        /// <returns>OK</returns>
