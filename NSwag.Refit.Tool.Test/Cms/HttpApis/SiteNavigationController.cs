...
namespace Cms
{
    public interface ISiteNavigationController
    {
        ...
        /// <summary>根据栏目所属区块sysno查询所有栏目</summary>
        ...
        /// <summary>根据父栏目sysno查询所有子栏目</summary>
        ...
        /// <summary>栏目移动（action为1表上移，2表下移）</summary>
        /// <param name="sysno">sysno</param>
